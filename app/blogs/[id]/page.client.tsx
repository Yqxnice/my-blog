  ...
  return (
    <div className="blog-post-wrapper">
      ...
      <div className="w-full">
        <div className="max-w-[1080px] mx-auto px-4 sm:px-4 flex items-center mb-6">
          <button
            onClick={() => router.back()}
        ...
        <div className="page-body">
          ...
          <article className="sm:px-0 px-4">
            <div className="mb-8 text-center">
              <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">{blog.title}</h1>
            ...
            {blog.imageUrl && (
              <div className="mb-6 w-full">
                <img
                  src={blog.imageUrl}
                  alt={blog.title}
                  className="w-full max-h-[200px] sm:max-h-[250px] object-cover rounded-lg border border-border"
                />
              </div>
            )}

            {blog.excerpt && (
              <blockquote className="italic mb-8 sm:mb-8">
                {blog.excerpt}
              </blockquote>
            )}
          ...
          {/* 右：目录 */}
          {toc.length > 0 && (
            <aside className="right-toc hidden sm:block">
